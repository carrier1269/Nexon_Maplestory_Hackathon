...
if TriggerBodyEntity.Id == _UserService.LocalPlayer.Id then
	...
	TriggerBodyEntity.MovementComponent:SetPosition(Vector2(1.435,-1.225))	
...
elseif TriggerBodyEntity.Take_Damage_Component.Take_Damage_Period == true then
	...
	TriggerBodyEntity.RigidbodyComponent:SetForce(Vector2(-1 * _UserService.LocalPlayer.PlayerControllerComponent.LookDirectionX, 3))
	wait(0.75)
