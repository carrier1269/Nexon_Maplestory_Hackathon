...
--@ BeginProperty
--@ SyncDirection=None
EntityRef GT = "39d5b301-15b8-4c03-9965-0aeb49f1439b"
--@ EndProperty
...
{
self.count = 1
self.npcTalkData = _DataService:GetTable("FinalTalk")
...
local key = event.key
--------------------------------------------------------
if key == KeyboardKey.Z and self.GT.GuideText.chatenable == true then
	self:ShowNextText()
end
