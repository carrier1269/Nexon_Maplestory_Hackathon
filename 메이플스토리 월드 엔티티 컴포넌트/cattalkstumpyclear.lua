...
--@ BeginProperty
--@ SyncDirection=None
boolean portalstate = "false"
--@ EndProperty

--@ BeginProperty
--@ SyncDirection=All
EntityRef newportal = "1c170e8f-5312-48bf-9b7e-627a755d0b0b"
--@ EndProperty
...
{
self.count = 1
self.npcTalkData = _DataService:GetTable("myhometalk2")
...
if self.newcount == 16 then
	self.portalstate = true
end
if self.portalstate == true then
	self.newportal.Enable = true
end
