...
if TriggerBodyEntity.Id == _UserService.LocalPlayer.Id then
	...
	TriggerBodyEntity.MovementComponent:SetPosition(Vector2(2.4, -12.6))
...
elseif TriggerBodyEntity.Take_Damage_Component.Take_Damage_Period == true then
	...
	TriggerBodyEntity.RigidbodyComponent:SetForce(Vector2(-5 * _UserService.LocalPlayer.PlayerControllerComponent.LookDirectionX, 8))
	wait(0.75)
	TriggerBodyEntity.Take_Damage_Component.Take_Damage_Period = true
end
end
