...
--@ BeginProperty
--@ SyncDirection=All
EntityRef BossState = "027f7d53-c682-48a4-ad71-2f1f974c07ed"
--@ EndProperty
...
--@ BeginProperty
--@ SyncDirection=None
Entity quest = "24b560d3-9b12-475b-bd29-0b33459b3bd7"
--@ EndProperty

--@ BeginProperty
--@ SyncDirection=None
Entity portal = "93c8decb-f6c3-4181-8eba-20f1ba375bc1"
--@ EndProperty
...
{
self.count = 1
self.npcTalkData = _DataService:GetTable("skilltalk2")
...
{
if leftMap.Name == "LastBossMap" then
        self.uiTalkPanel.Enable = false
end
}
--@ EndMethod
