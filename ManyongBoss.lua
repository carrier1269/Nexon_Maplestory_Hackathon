...
--@ BeginProperty
--@ SyncDirection=All
EntityRef manyongportal = "93c8decb-f6c3-4181-8eba-20f1ba375bc1"
--@ EndProperty
...
{
self.IsDead = true
_SpawnService:SpawnByModelId("model://f57f38f3-24c4-4f30-a30c-c81978300fe9", "B등급", self.Entity.TransformComponent.Position, _EntityService:GetEntityByPath("/maps/map08"), nil)
...
if CurrentStateName == "DEAD" then
	self.manyongportal.Enable = true
else
	self.manyongportal.Enable = false
end
}
--@ EndEntityEventHandler
