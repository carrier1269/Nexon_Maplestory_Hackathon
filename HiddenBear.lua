...
--@ BeginProperty
--@ SyncDirection=All
EntityRef minibear = "14023e56-6130-48aa-be34-6774248f93fa"
--@ EndProperty
...
--@ BeginProperty
--@ SyncDirection=None
EntityRef hiddenportal = "5cbb0c15-4c59-41f4-a91c-1737565e6450"
--@ EndProperty
...
{
self.count = 1
self.npcTalkData = _DataService:GetTable("beartalk")
...
if key == KeyboardKey.Z and self.CollisionState == true then
	self:ShowNextText()
	wait(4)
	self.minibear.Enable = false
	self.count = self.count +1
end

if self.minibear.Enable == false then
	self.hiddenportal.Enable = true
end
